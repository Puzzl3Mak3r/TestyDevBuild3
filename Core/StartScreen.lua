...
function Animate(option)
    ...
    if option == "remove" then
        ...
        transition.to(titleScreen, {alpha = 0, time = 200})
        transition.to(scroll00, {alpha = 0, time = 400})
        transition.to(scroll01, {alpha = 0, time = 400})
        transition.to(scroll10, {alpha = 0, time = 400})
        transition.to(scroll11, {alpha = 0, time = 400})
